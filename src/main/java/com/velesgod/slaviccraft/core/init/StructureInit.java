...
import com.velesgod.slaviccraft.world.structure.structures.LeshinTemple;
...
public class StructureInit {
     ...
     */
    public static final DeferredRegister<StructureFeature<?>> SlavicStructures =
            DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, SlavicCraftMod.MOD_ID);
    ...
    public static final RegistryObject<StructureFeature<?>> SKY_STRUCTURES =
    		SlavicStructures.register("leshin_temple", LeshinTemple::new);


    public static void register(IEventBus eventBus) {
    	SlavicStructures.register(eventBus);
    }
}