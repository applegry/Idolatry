...
public class ParticleTypeRaven extends TextureSheetParticle{

	protected ParticleTypeRaven(ClientLevel p_i232448_1_, double p_i232448_2_, double p_i232448_4_, double p_i232448_6_,
	...
	public void tick() {
		...
		//this.setSprite(this.spriteSet.get(new Random()));
		if(this.age-- <= 0) {
			this.remove();
		} else {
	...
	public static class Provider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType p_199234_1_, ClientLevel p_199234_2_, double p_199234_3_,
			...
			ParticleTypeRaven particle = new ParticleTypeRaven(p_199234_2_,p_199234_3_,p_199234_5_,  p_199234_7_,  p_199234_9_, p_199234_11_,  p_199234_13_);
