...
import com.velesgod.slaviccraft.client.model.armor.LeshinAmuletModel;
...
public class LeshinAmuletRenderer extends GeoArmorRenderer<LeshinAmuletItem> {
	public LeshinAmuletRenderer() {
		super(new LeshinAmuletModel());
