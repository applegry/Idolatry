...
public class PowerAmuletItem extends GeoArmorItem implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);

	public PowerAmuletItem(ArmorMaterial materialIn, EquipmentSlot slot, Properties builder) {
