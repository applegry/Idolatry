...
public class LeshinAmuletItem extends GeoArmorItem implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);

	public LeshinAmuletItem(ArmorMaterial materialIn, EquipmentSlot slot, Properties builder) {
