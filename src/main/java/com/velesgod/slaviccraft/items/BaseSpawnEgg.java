...
public class BaseSpawnEgg extends SpawnEggItem {
    protected static final List<BaseSpawnEgg> UNADDED_EGGS = new ArrayList<>();
    private final Lazy<? extends EntityType<?>> entityTypeSupplier;

    @SuppressWarnings("deprecation")
	public BaseSpawnEgg(final RegistryObject<? extends EntityType<?>> entityTypeSupplier,
