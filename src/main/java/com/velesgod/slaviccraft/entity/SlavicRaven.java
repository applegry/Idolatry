...
public class SlavicRaven extends PathfinderMob implements IAnimatable, IAnimationTickable {
	...
	public SlavicRaven(EntityType<? extends PathfinderMob> type, Level worldIn) {
		super(type, worldIn);
		this.noCulling = true;
	}
